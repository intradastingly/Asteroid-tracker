      ...
      <div style={rootStyle}>
         ...
         <div style={innerDivStyle}>
            ...
            <div>
               ...
               <p style={pStyling}>
                  {props.ingredients2} {props.ingredientsAmount1}
               </p>
               <p style={pStyling}>
                  {props.ingredients3} {props.ingredientsAmount2}
               </p>
               <p style={pStyling}>
                  {props.ingredients4} {props.ingredientsAmount3}
               </p>
               <p style={pStyling}>
                  {props.ingredients5} {props.ingredientsAmount4}
               </p>
            </div>
         </div>
      </div>
